  ...
  <section>
    <div class="container-fluid">
      ...
      <div class="row">
        <?php
          $id = $_GET['id'];
          $perintah = "SELECT *, agent.created_at AS pembelian FROM tb_management_agent AS agent INNER JOIN tb_properties AS properties ON agent.id_properties_management_agent = properties.id_properties WHERE id_agent_management_agent = '$id' AND status_management_agent > 0";
          $query = mysqli_query($conn, $perintah);
          while ($data = mysqli_fetch_array($query)) {
            $status = $data['status_management_agent'];
            if ($status == 1) {
              $status = "Tersedia";
            } else if ($status == 2) {
            ...
            $pembelian = "Pembelian : ".$data['pembelian'];
        ...
        <div class="col-md-6 col-lg-3">
          ...
          <div class="card"><img src="../public/img/<?php echo $data['img']; ?>" alt="Card image cap" class="card-img-top img-fluid">
            <div class="card-body">
              <h5 class="card-title"><?php echo $data['name_properties']." - $".$data['price']; ?></h5>
