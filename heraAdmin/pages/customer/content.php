    ...
    <div class="container-fluid">
      <div class="card">
        <div class="card-header">
          ...
          <h4>Verfikasi Properti Customer</h4>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table id="datatable1" style="width: 100%;" class="table">
              ...
              <tbody>
                <?php
                  $perintah = "SELECT * FROM tb_validate AS validate INNER JOIN tb_properties AS properties ON validate.id_properties = properties.id_properties INNER JOIN tb_users AS users ON validate.id_customer = users.id_users WHERE status_validate = '4'";
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a onClick="return confirm('Apakah anda ingin mensetujui permintaan ini?')" href="?page=customer&aksi=validate&id=<?php echo $dataAdmin['id_validate']?>" class="btn btn-success"><i class="fa fa-check"></i></a>
                    <a onClick="return confirm('Apakah anda ingin menolak permintaan ini?')" href="?page=customer&aksi=delete&id=<?php echo $dataAdmin['id_validate']?>" class="btn btn-danger"><i class="fa fa-close"></i></a>
                  </td>
                </tr>
                <?php
                  }
