    ...
    <div class="row justify-content-center">
      <div class="col-12 col-md-8 col-lg-6">
        ...
        <h2 class="mb-4 text-center">
          Management Properti Customer<br /> 
          <u><?php echo $owner; ?></u>
        </h2>
      ...
      <div class="col-12">
        ...
        <nav class="nav nav-pills justify-content-center mb-6">
          ...
          <a href="#menuFour" class="nav-link" data-toggle="tab">
            Properti Customer <?php echo $owner; ?>
          </a>
        </nav>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="tblAdmin">
                      ...
                      <tbody>
                        <?php
                          $id = $_SESSION['login'];
                          $perintah = "SELECT * FROM tb_validate INNER JOIN tb_properties ON tb_validate.id_properties = tb_properties.id_properties WHERE id_customer = '$id' AND status_validate = '4'";
                          $data = mysqli_query($conn, $perintah);
                        ...
                        <tr>
                          ...
                          <th>
                            ...
                            <a onClick="return confirm('Apakah anda ingin menghapus permintaan ini?')" href="?page=customer&aksi=delete&id=<?php echo $dataAdmin['id_validate']?>" class="btn btn-danger" style="padding: 3px 4px 3px 4px; border-radius: 10%;">
                ...
                <div class="table-responsive">
                    ...
                    <thead>
                      ...
                      <tbody>
                        <?php
                          $id = $_SESSION['login'];
                          $perintah1 = "SELECT * FROM tb_validate INNER JOIN tb_properties ON tb_validate.id_properties = tb_properties.id_properties WHERE id_customer = '$id' AND status_validate = '5'";
                        ...
                        <tr>
                          ...
                          <th>
                            <a href="?page=customer&aksi=cardname&id=<?php echo $dataOwner1['id_properties']?>" class="btn btn-info" style="padding: 3px 4px 3px 4px; border-radius: 10%;">
                              <img src="https://img.icons8.com/material-outlined/24/000000/visible--v2.png"/>
                            </a>
                          </th>
                        </tr>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="tblTolak">
                      ...
                      <tbody>
                        <?php
                          $id = $_SESSION['login'];
                          $perintah2 = "SELECT * FROM tb_validate INNER JOIN tb_properties ON tb_validate.id_properties = tb_properties.id_properties WHERE id_customer = '$id' AND status_validate < 0";
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="tblOwner">
                      ...
                      <tbody>
                        <?php
                          $id = $_SESSION['login'];
                          $perintah3 = "SELECT * FROM tb_management_customer AS customer INNER JOIN tb_management_agent AS agent ON customer.id_management_agent_management_customer = agent.id_management_agent INNER JOIN tb_properties AS properties ON agent.id_properties_management_agent = properties.id_properties INNER JOIN tb_users AS user ON agent.id_agent_management_agent = user.id_users WHERE id_customer_management_customer = '$id' AND status_management_customer > 0";
                        ...
                        <tr>
                          ...
                          <th><?php echo $dataAgent1['name']; ?></th>
                          <th>
                            ...
                            <a onClick="return confirm('Apakah anda ingin menghapus properti ini?')" href="?page=customer&aksi=delete2&id=<?php echo $dataAgent1['id_management_customer']?>" class="btn btn-danger" style="padding: 3px 4px 3px 4px; border-radius: 10%;">
                              <img src="https://img.icons8.com/android/24/000000/trash.png"/>
                            </a>
                          </th>
                        </tr>
