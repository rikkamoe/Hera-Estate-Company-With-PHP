  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-12 col-md-8 col-lg-6">
        <?php
            $id = $_GET['id'];
            $perintah = "SELECT * FROM tb_management_agent AS management INNER JOIN tb_users AS user ON management.id_agent_management_agent = user.id_users INNER JOIN tb_properties AS properties ON management.id_properties_management_agent = properties.id_properties WHERE id_properties_management_agent = '$id'";
        ...
        <h2 class="mb-4 text-center">
          <u>Kartu Nama Agent Properti</u><br />
            ...
            <div class="card-body text-center">
              ...
              <ul class="card-text list-iconed">
                <li class="list-iconed-item">
                  Hubungi agent segera mungkin agar tidak ketinggalan update !
                </li>
                <li class="list-iconed-item">
                  Kesepakati terlebih dahulu lalu miliki properti bersama agent !
                </li>
                <li class="list-iconed-item">
                  Pilih propertimu dengan leluasa di Hera Estate Company !
                </li>
              </ul>
